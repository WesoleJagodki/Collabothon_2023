    ...
    return (
        <Badge shadow={4} rounded={20} style={chooseInterestsScreen.badge}>
            <Box style={chooseInterestsScreen.imageBox}>
                <Image
                    source={imageSource}
                    style={chooseInterestsScreen.image}
                />
...
export function ChooseInterestsScreen({ navigation }: any) {
    return (
        <Box style={commonStyle.appScreen}>
            ...
            <Text style={chooseInterestsScreen.text2}>Help us understand your preferences to curate challenges and offers tailored just for you!</Text>
            <ScrollView>
                <BadgeImage
